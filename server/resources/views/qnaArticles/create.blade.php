...
<div class="container">
    ...
    <form action="{{ route('qnaArticles.store') }}" method="post" id="myArticle">
        ...
        <div class="form-group {{ $errors->has('category') ? 'has-error' : ''}}">
            <label for="category">글 유형</label>
            <select name='category' id="category" form="myArticle">
                <option value='' selected>-- 선택 --</option>
                <option value='free'>자유게시판</option>
                <option value='sugesstion'>건의사항</option>
